...
- ユーザとのやり取りは日本語で実施すること
- ユーザの指示に対する翻訳は英語で行うこと
- ユーザの指示に対するWeb上の検索は英語で行うこと
...
## 13. ドキュメント構造 / Document Structure

### 13.1 .claude ディレクトリ
このプロジェクトでは `.claude/` ディレクトリに開発に関するドキュメントを配置します：

```
.claude/
├── CLAUDE.md          # このファイル（コーディング規約）
├── ARCHITECTURE.md    # プロジェクト構造とワークフロー
└── templates/         # ドキュメントテンプレート
```

### 13.2 関連ドキュメント
- **ARCHITECTURE.md**: プロジェクト構造、ドキュメント駆動開発の詳細
- **templates/**: 機能仕様書やタスクのテンプレート
